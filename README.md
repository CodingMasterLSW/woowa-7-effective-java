...
- [x] 3. [private 생성자나 열거 타입으로 싱글턴임을 보증하라](./02장/3_싱글턴에서의_private_생성자.md) - 돔푸
...
- [x] 18. [상속보다는 컴포지션을 사용하라](./04장/18_상속보다는_컴포지션을_사용하라.md) - 젠슨
- [x] 19. [상속을 고려해 설계하고 문서화하라. 그러지 않았다면 상속을 금지하라.](./04장/19_상속을_고려해_설계하고_문서화하라._그러지_않았다면_상속을_금지하라.md) - 젠슨
- [x] 20. [추상 클래스보다는 인터페이스를 우선하라](./04장/20_추상_클래스보다는_인터페이스를_우선하라.md) - 가이온
...
- [x] 23. [태그 달린 클래스보다는 클래스 계층구조를 활용하라](./04장/23_태그_달린_클래스보다는_클래스_계층구조를_활용하라.md) - 포라
- [x] 24. [멤버 클래스는 되도록 static으로 만들라](./04장/24_멤버_클래스는_되도록_static으로_만들라.md) - 가이온
- [x] 25. [톱레벨 클래스는 한 파일에 하나만 담으라](./04장/25_톱레벨_클래스는_한_파일에_하나만_담으라.md) - 포라
- [ ] 26. 로 타입은 사용하지 말라
- [ ] 27. 비검사 경고를 제거하라
- [x] 28. [배열보다는 리스트를 사용하라](./05장/28_배열보다는_리스트를_사용하라.md) - 포라
- [x] 29. [이왕이면 제네릭 타입으로 만들라](./05장/29_이왕이면_제네릭_타입으로_만들라.md) - 포라
...
- [x] 38. [확장할 수 있는 열거 타입이 필요하면 인터페이스를 사용하라](./06장/38_확장할_수_있는_열거형이_필요하면_인터페이스를_사용하라.md) - 돔푸
...
- [x] 44. [표준 함수형 인터페이스를 사용하라](./07장/44_표준_함수형_인터페이스를_사용하라.md) - 돔푸
- [x] 45. [스트림은 주의해서 사용하라](./07장/45_스트림은_주의해서_사용하라.md) - 가이온
- [ ] 46. 스트림에서는 부작용 없는 함수를 사용하라
- [ ] 47. 반환 타입으로는 스트림보다 컬렉션이 낫다
- [x] 48. [스트림 병렬화는 주의해서 적용하라](./07장/48_스트림_병렬화는_주의해서_적용하라.md) - 돔푸
- [ ] 49. 매개변수가 유효한지 검사하라
- [x] 50. [적시에 방어적 복사본을 만들라](./08장/50_적시에_방어적_복사본을_만들라.md) - 젠슨
- [x] 51. [메서드 시그니처를 신중히 설계하라](./08장/51_메서드_시그니처를_신중히_설계하라.md) - 돔푸
- [x] 52. [다중정의는 신중히 사용하라](./08장/52_다중정의는_신중히_사용하라.md) - 돔푸
- [x] 53. [가변인수는 신중히 사용하라](./08장/53_가변인수는_신중히_사용하라.md) - 돔푸
- [x] 54. [null이 아닌, 빈 컬렉션이나 배열을 반환하라](./08장/54_null_이_아닌_빈_컬렉션이나_배열을_반환하라.md) - 가이온
- [x] 55. [옵셔널 반환은 신중히 하라](./08장/55_옵셔널_반환은_신중히_하라.md.md) - 가이온
- [ ] 56. 공개된 API 요소에는 항상 문서화 주석을 작성하라
- [x] 57. [지역변수의 범위를 최소화하라](./09장/57_지역변수의_범위를_최소화하라.md) - 젠슨
- [x] 58. [전통적인 for 문보다는 for-each 문을 사용하라](./09장/58_전통적인_for_문보다는_for-each_문을_사용하라.md) - 돔푸
- [x] 59. [라이브러리를 익히고 사용하라](./09장/59_라이브러리를_익히고_사용하라.md) - 돔푸
- [x] 60. [정확한 답이 필요하다면 float와 double은 피하라](./09장/60_정확한_답이_필요하다면_float와_double은_피하라.md) - 가이온
- [ ] 61. 박싱된 기본 타입보다는 기본 타입을 사용하라
- [ ] 62. 다른 타입이 적절하다면 문자열 사용을 피하라
- [x] 63. [문자열 연결은 느리니 주의하라](./09장/63_문자열_연결은_느리니_주의하라라.md) - 가이온
- [ ] 64. 객체는 인터페이스를 사용해 참조하라
- [ ] 65. 리플렉션보다는 인터페이스를 사용하라
- [ ] 66. 네이티브 메서드는 신중히 사용하라
- [ ] 67. 최적화는 신중히 하라
- [x] 68. [일반적으로 통용되는 명명 규칙을 따르라](./09장/68_일반적으로_통용되는_명명_규칙을_따르라.md) - 포포
- [x] 69. [예외는 진짜 예외 상황에만 사용하라](./10장/69_예외는_진짜_예외_상황에만_사용하라.md) - 젠슨
- [x] 70. [복구할 수 있는 상황에는 검사 예외를, 프로그래밍 오류에는 런타임 예외를 사용하라](./10장/69_예외는_진짜_예외_상황에만_사용하라.md) - 젠슨
...
- [x] 76. [가능한 한 실패 원자적으로 만들라](./10장/76_가능한_한_실패_원자적으로_만들라.md) - 젠슨
- [x] 77. [예외를 무시하지 말라](./10장/77_예외를_무시하지_말라.md) - 젠슨
- [ ] 78. 공유 중인 가변 데이터는 동기화해 사용하라
- [ ] 79. 과도한 동기화는 피하라
- [ ] 80. 스레드보다는 실행자, 태스크, 스트림을 애용하라
- [x] 81. [wait와 notify보다는 동시성 유틸리티를 애용하라](./11장/81_wait과_notify_보다는_동시성_유틸리티를_애용하라.md) - 돔푸
- [ ] 82. 스레드 안전성 수준을 문서화하라
- [x] 83. [지연 초기화는 신중히 사용하라](./11장/83_지연_초기화는_신중히_사용하라.md) - 돔푸
