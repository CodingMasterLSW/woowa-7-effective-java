...
- [x] 1. [생성자 대신 정적 팩터리 메서드를 고려하라](./02장/생성자_대신_정적_팩터리_메서드를_고려하라.md)- 젠슨 
- [x] 2. [생성자에 매개변수가 많다면 빌더를 고려하라](./02장/생성자에_매개변수가_많다면_빌더를_고려하라.md) - 젠슨
...
- [x] 70. [복구할 수 있는 상황에는 검사 예외를, 프로그래밍 오류에는 런타임 예외를 사용하라](.10장/70_복구할_수_있는_상황에는_검사_예외를,_프로그래밍_오류에는_런타임_예외를_사용하라.md) - 젠슨
